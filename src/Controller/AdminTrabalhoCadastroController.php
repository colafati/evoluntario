...
class AdminTrabalhoCadastroController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $form = $this->createFormBuilder($trabalho)
                ...
                ->add('dataInicio', DateType::class, array('attr' => ['class'=>'form-control'], 'widget'=>'single_text', 'required' => false))
                ->add('dataFim', DateType::class, array('attr' => ['class'=>'form-control'], 'widget'=>'single_text', 'required' => false))
                ->add('periodo', TextType::class, array('attr' => ['class'=>'form-control'], 'required' => false))
                ->add('site', UrlType::class, array('attr' => ['class'=>'form-control'], 'required' => false))
                ->add('cidade', TextType::class, array('attr' => ['class'=>'form-control']))
                ->add('telefone', TextType::class, array('attr' => ['class'=>'form-control'], 'required' => false))
